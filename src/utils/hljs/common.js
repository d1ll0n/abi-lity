...
function baseAssembly(hljs) {
  ...
  let SOL_ASSEMBLY_LEXEMES_RE = /[A-Za-z_$][A-Za-z_$0-9.]*/;

  let SOL_ASSEMBLY_TITLE_MODE = hljs.inherit(hljs.TITLE_MODE, {
    begin: /[A-Za-z$_][0-9A-Za-z$_]*/,
    lexemes: SOL_ASSEMBLY_LEXEMES_RE,
    keywords: SOL_ASSEMBLY_KEYWORDS
  });

  let SOL_ASSEMBLY_FUNC_PARAMS = {
    className: "params",
    begin: /\(/,
    end: /\)/,
    excludeBegin: true,
